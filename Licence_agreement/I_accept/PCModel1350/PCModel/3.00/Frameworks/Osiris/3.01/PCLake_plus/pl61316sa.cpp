...
_uDepthMixMeas_ =_IF_ ( _calcMixDepth_ _EQ_ _TRUE_ ) _THEN_ _cAMix_ * _POW_ ( _cFetch_ , (_cBMix_) ) _ELSE_ _mMixDepth_ _ENDIF_;
_uDepthW_= _IF_ _sDepthW_ _GT_ _cDepthWMin_ _THEN_ _sDepthW_ _ELSE_ _cDepthWMin_ _ENDIF_;
...
_aExtSurf_ = _cExtSpBlue_ * _sDBlueSurf_;
...
_aLPARBotHypOpen_ = _aLPARBotEpiOpen_ * _EXP_(- _aExtCoefOpenHyp_ * _uDepthWEpi_);
...
_aQEv_ = _IF_ (10 *_uTmEpi_ /_cHeath_) _LE_ _NearZero_ _THEN_ 16 * 2*_ufDay_ * 1 / 30 * _POW_ ( _NearZero_ , (_cAlpha_) ) _ELSE_ 16 * 2*_ufDay_ * 1 / 30 * _POW_ ( 10 *_uTmEpi_ /_cHeath_ , (_cAlpha_) ) _ENDIF_;
...
_uDepthDifMeas_ = _IF_ ( _ReadDepthW_ _EQ_ _TRUE_ ) _THEN_ _uDepthW_ - _mDepthW_ _ELSE_ 0.0 _ENDIF_;
_uQCor_ = _uDepthDifMeas_ * _cMaxWOut_ * _mmPerm_;
_uQIn_ = _IF_ (_ReadQIn_ _EQ_ _TRUE_ _AND_ _ReadDepthW_ _EQ_ _TRUE_)  _THEN_ _MAX_ (_mQIn_, _mQIn_-_uQCor_) _ELSEIF_ (_ReadQIn_ _EQ_ _TRUE_) _THEN_ _mQIn_ _ELSEIF_ (_UseSeasonLoad_ _EQ_ _TRUE_) _THEN_ _uQInSeason_ + _uQInExtra_ _ELSE_ _cQIn_ + _uQInExtra_ _ENDIF_;
...
_uInfHyp_ = _IF_ ( _aInclStrat_ _EQ_ _TRUE_ ) _THEN_ _cQInf_ _ELSE_ 0.0 _ENDIF_;
_uInfEpi_ = _IF_ ( _aInclStrat_ _EQ_ _FALSE_ ) _THEN_ _cQInf_ _ELSE_ 0.0 _ENDIF_;
_uQOutHyp_ = _IF_ (_ReadQOutHyp_ _EQ_ _TRUE_) _THEN_ _MAX_(_mQOutHyp_, (_uDepthWHyp_ - _cDepthWMax_) * _cMaxWOut_ * _mmPerm_) _ELSEIF_ (_FALSE_ _EQ_ _aInclStrat_) _THEN_ 0.0 _ELSE_ _MAX_(0.0, (_uQIn_ - _uQInExtra_) - _uQEv_ - _uInfHyp_ ) + _uQOutExtra_ _ENDIF_;
_uQOutEpi_ = _IF_ (_ReadQOutEpi_ _EQ_ _TRUE_) _THEN_ _MAX_(_mQOutEpi_, (_uDepthWEpi_ - _cDepthWMax_) * _cMaxWOut_ * _mmPerm_)  _ELSEIF_ (_ReadDepthW_ _EQ_ _TRUE_) _THEN_ _MAX_(0.0, _uQCor_ + ((_uQIn_ - _uQInExtra_) - _uQEv_ - _uInfHyp_ - _uInfEpi_-_uQOutHyp_)) + _uQOutExtra_ _ELSEIF_ (_ConstDepth_ _EQ_ _TRUE_ ) _THEN_ _MAX_(0.0, (_uQIn_ - _uQInExtra_) - _uQEv_ - _uInfHyp_ - _uInfEpi_-_uQOutHyp_) + _uQOutExtra_  _ELSE_ 0.0 _ENDIF_;
_uQDilEpi_ = _uQOutEpi_;
_uQDilHyp_ = _uQOutHyp_;
_ukDilEpi_ = _IF_ (_FALSE_ _EQ_ _InclTran_) _THEN_ 0.0 _ELSE_ _uQDilEpi_ / _mmPerm_ / _uDepthWEpi_ _ENDIF_;
_ukDilHyp_ = _IF_ (_FALSE_ _EQ_ _InclTran_) _THEN_ 0.0 _ELSE_ _uQDilHyp_ / _mmPerm_ / _uDepthWHyp_ _ENDIF_;
_ukDilWatEpi_ = _uQIn_ / _mmPerm_ / _uDepthWEpi_;
_ukDilWatHyp_ = 0.0;
...
_uTauWatEpi_ = _IF_ ( _aInclStrat_ _EQ_ _FALSE_ _AND_ _cQInf_ _LT_ 0.0 ) _THEN_ 1.0 / ((_uQIn_ - _cQInf_) / _mmPerm_ / _uDepthWEpi_ +_NearZero_) _ELSE_ 1.0 / ((_uQIn_ ) / _mmPerm_ / _uDepthWEpi_ +_NearZero_) _ENDIF_;
_uTauWatHyp_ = _IF_ ( _aInclStrat_ _EQ_ _FALSE_ )_THEN_ -9999 _ELSEIF_ (_cQInf_ _LT_ 0.0 ) _THEN_ 1.0 / ((- _cQInf_ ) / _mmPerm_ / _uDepthWHyp_ +_NearZero_) _ELSE_ 1.0 / ( _cQInf_ / _mmPerm_ / _uDepthWHyp_ +_NearZero_) _ENDIF_;
_uTauWat_ = _IF_ ( _cQInf_ _GT_ 0.0 ) _THEN_ 1.0 / (_uQIn_ / _mmPerm_ / _uDepthW_ +_NearZero_) _ELSE_ 1.0 / ((_uQIn_ - _cQInf_ ) / _mmPerm_ / _uDepthW_ +_NearZero_) _ENDIF_;
_uTauSubstHyp_ = 1.0 / (_ukDilHyp_+_NearZero_);
...
_vTranDepthW_ = _IF_ ( _ConstDepth_ _EQ_ _TRUE_) _THEN_ 0.0 _ELSEIF_ (_FALSE_ _EQ_ _InclMarsh_ _OR_ _fMarsh_ _LE_ _NearZero_) _THEN_ (_uQIn_ - _uQEv_ - _cQInf_ - _uQOutHyp_ - _uQOutEpi_) / _mmPerm_ _ELSE_ ((_uQIn_ - _uQEv_ - _cQInf_ - _uQOutHyp_ - _uQOutEpi_) / _mmPerm_) / (1.0 + _fMarsh_) _ENDIF_;
...
_vDeltaWHyp_ = _IF_ ( _ConstDepth_ _EQ_ _TRUE_ _OR_ _FALSE_ _EQ_ _aInclStrat_ ) _THEN_ 0.0 _ELSEIF_ (_FALSE_ _EQ_ _InclMarsh_ _OR_ _fMarsh_ _LE_ _NearZero_ ) _THEN_ ( - _uInfHyp_ - _uQOutHyp_) / _mmPerm_ _ELSE_ ( - _uInfHyp_ - _uQOutHyp_) / _mmPerm_ / (1.0 + _fMarsh_ ) _ENDIF_;
_vDeltaWEpi_ = _IF_ (_ConstDepth_ _EQ_ _TRUE_ ) _THEN_ 0.0 _ELSEIF_ ( _FALSE_ _EQ_ _InclMarsh_ _OR_ _fMarsh_ _LE_ _NearZero_ ) _THEN_ (_uQIn_ - _uQEv_ - _uQOutEpi_ - _uInfEpi_) / _mmPerm_ _ELSE_ (_uQIn_ - _uQEv_ - _uQOutEpi_ - _uInfEpi_ ) / _mmPerm_ / (1.0 + _fMarsh_ ) _ENDIF_;
...
_aPInorgSM_ = _IF_ (_InclMarsh_ _EQ_ _TRUE_ _AND_ _fMarsh_ _GT_ _NearZero_) _THEN_ _sPO4SM_ + _aPAIMSM_ _ELSE_ 0.0 _ENDIF_;
...
_aPTotM_ = _IF_ (_InclMarsh_ _EQ_ _TRUE_ _AND_ _fMarsh_ _GT_ _NearZero_) _THEN_ ((_oPO4WM_ + _oPDetWM_ + _oPAIMWM_ + _oPPhytWM_ + _oPZooM_) * _uDepthWM_ + _sPO4SM_ + _aPHumSM_ + _aPDetSM_ + _aPAIMSM_ + _aPShootPhra_ + _aPRootPhra_) * _fMarsh_ _ELSE_ 0.0 _ENDIF_;
...
_uPLoad_ = _IF_ (_FALSE_ _EQ_ _InclTran_) _THEN_ 0.0 _ELSEIF_ (_ReadPLoad_ _EQ_ _TRUE_ _AND_ _ReadNutFrac_ _EQ_ _TRUE_) _THEN_ _mPLoadPO4_ + _mPLoadOrg_ _ELSEIF_ (_ReadPLoad_ _EQ_ _TRUE_ _AND_ _FALSE_ _EQ_ _ReadNutFrac_) _THEN_ _mPLoad_ * _mPLoadMult_ _ELSEIF_ (_UsePulseLoad_ _EQ_ _TRUE_) _THEN_ 0.0 _ELSEIF_ (_UseSeasonLoad_ _EQ_ _TRUE_) _THEN_ _uPLoadSeason_ _ELSE_ _cPLoad_ _ENDIF_;
_uPLoadPO4_ = _IF_ (_FALSE_ _EQ_ _ReadPLoad_) _THEN_ _fPO4In_ * _uPLoad_ _ELSEIF_ (_ReadNutFrac_ _EQ_ _TRUE_) _THEN_ _mPLoadPO4_ _ELSE_ _fPO4In_ * _uPLoad_ _ENDIF_;
_uPLoadOrg_ = _IF_ (_FALSE_ _EQ_ _ReadPLoad_) _THEN_ (1.0 - _fPO4In_) * _uPLoad_ _ELSEIF_ (_ReadNutFrac_ _EQ_ _TRUE_) _THEN_ _mPLoadOrg_ _ELSE_ (1.0 - _fPO4In_) * _uPLoad_ _ENDIF_;
_uPLoadPhytTot_ = _IF_ (_FALSE_ _EQ_ _InclSeason_) _THEN_ (((_fPhytInSum_ + _fPhytInWin_)/2)*_uPLoadOrg_) _ELSEIF_ (_ReadPLoadPhyt_ _EQ_ _TRUE_) _THEN_ _mPLoadPhytTot_ _ELSE_ ((_fPhytInSum_+_fPhytInWin_)/2.0 - (_fPhytInSum_-_fPhytInWin_)/2.0 * _COS_(2.0*_Pi_ * (_sTime_ + _TenDays_ - _cTimeLag_) / _DaysInYear_)) * _uPLoadOrg_ _ENDIF_;
...
_uNLoadPhytTot_ = _IF_ _ReadNutFrac_ _EQ_ _FALSE_ _THEN_ _cNPPhytIn_ * _uPLoadPhytTot_ _ELSE_  _mNLoadPhytTot_ _ENDIF_ ;
_uNLoad_ = _IF_ (_FALSE_ _EQ_ _InclTran_) _THEN_ 0.0 _ELSEIF_ (_ReadNLoad_ _EQ_ _TRUE_ _AND_ _ReadNutFrac_ _EQ_ _TRUE_) _THEN_ _mNLoadNH4_ + _mNLoadNO3_ + _mNLoadOrg_ _ELSEIF_ (_ReadNLoad_ _EQ_ _TRUE_ _AND_ _FALSE_ _EQ_ _ReadNutFrac_) _THEN_ _mNLoad_ _ELSEIF_ (_UsePulseLoad_ _EQ_ _TRUE_) _THEN_ 0.0 _ELSEIF_ (_ReadPLoad_ _EQ_ _TRUE_) _THEN_ _cNPLoadMeas_ * _uPLoad_ _ELSEIF_ (_UseSeasonLoad_ _EQ_ _TRUE_) _THEN_ _uNLoadSeason_ _ELSE_ _cNLoad_ _ENDIF_;
_uNLoadDet_ = _IF_ (_FALSE_ _EQ_ _ReadNLoad_) _THEN_ _MIN_(_cNPDetIn_ * _uPLoadDet_, _uNLoad_ - _uNLoadPhytTot_) _ELSEIF_ (_ReadNutFrac_ _EQ_ _TRUE_) _THEN_ _mNLoadOrg_ - _mNLoadPhytTot_ _ELSE_ _MIN_(_cNPDetIn_ * _uPLoadDet_, _uNLoad_ - _uNLoadPhytTot_) _ENDIF_;
...
_uDLoadIM_ = _IF_ (_FALSE_ _EQ_ _InclTran_) _THEN_ 0.0 _ELSEIF_ (_ReadDLoadIM_ _EQ_ _TRUE_) _THEN_ _mDLoadIM_ _ELSE_ _cDIMIn_ * _uQIn_ / _mmPerm_ _ENDIF_;
_uDLoad_ = _IF_ (_FALSE_ _EQ_ _InclTran_) _THEN_ 0.0 _ELSE_ _uDLoadIM_ + _uDLoadDet_ + _uDLoadPhytTot_ _ENDIF_;
...
_wDDilIMHyp_ = _ukDilHyp_ * _oDIMWHyp_;
_wDDilDetHyp_ = _ukDilHyp_ * _oDDetWHyp_;
_wDDilGrenHyp_ = _ukDilHyp_ * _oDGrenWHyp_;
_wDDilBlueHyp_ = _ukDilHyp_ * _oDBlueWHyp_;
_wDDilDiatHyp_ = _ukDilHyp_ * _oDDiatWHyp_;
_wDDilZooHyp_ = _ukDilHyp_ * _oDZooHyp_;
_wDDilPhytHyp_ = _wDDilDiatHyp_ + _wDDilGrenHyp_ + _wDDilBlueHyp_;
_wPDilZooHyp_ = _ukDilHyp_ * _oPZooHyp_;
_wNDilZooHyp_ = _ukDilHyp_ * _oNZooHyp_;
_wPDilPO4Hyp_ = _ukDilHyp_ * _oPO4WHyp_;
_wPDilDetHyp_ = _ukDilHyp_*_oPDetWHyp_;
_wPDilAIMHyp_ = _ukDilHyp_ * _oPAIMWHyp_;
_wNDilNH4Hyp_ = _ukDilHyp_ * _oNH4WHyp_;
_wNDilNO3Hyp_ = _ukDilHyp_ * _oNO3WHyp_;
_wNDilDetHyp_ = _ukDilHyp_ * _oNDetWHyp_;
_wO2InflowHyp_ = _ukDilWatHyp_ * _cO2In_;
_wO2OutflHyp_ = _ukDilHyp_ * _oO2WHyp_;
_wPDilDiatHyp_ = _ukDilHyp_ * _oPDiatWHyp_;
_wNDilDiatHyp_ = _ukDilHyp_ * _oNDiatWHyp_;
_wPDilGrenHyp_ = _ukDilHyp_ * _oPGrenWHyp_;
_wNDilGrenHyp_ = _ukDilHyp_ * _oNGrenWHyp_;
_wPDilBlueHyp_ = _ukDilHyp_ * _oPBlueWHyp_;
_wNDilBlueHyp_ = _ukDilHyp_ * _oNBlueWHyp_;
...
_wDTranDiatHyp_ = _IF_ (_FALSE_ _EQ_ _InclTran_) _THEN_ 0.0 _ELSE_ - _wDDilDiatHyp_ _ENDIF_;
_wPTranDiatHyp_ = _IF_ (_FALSE_ _EQ_ _InclTran_) _THEN_ 0.0 _ELSE_ - _wPDilDiatHyp_ _ENDIF_;
_wNTranDiatHyp_ = _IF_ (_FALSE_ _EQ_ _InclTran_) _THEN_ 0.0 _ELSE_ - _wNDilDiatHyp_ _ENDIF_;
_wDTranGrenHyp_ = _IF_ (_FALSE_ _EQ_ _InclTran_) _THEN_ 0.0 _ELSE_ - _wDDilGrenHyp_ _ENDIF_;
_wPTranGrenHyp_ = _IF_ (_FALSE_ _EQ_ _InclTran_) _THEN_ 0.0 _ELSE_ - _wPDilGrenHyp_ _ENDIF_;
_wNTranGrenHyp_ = _IF_ (_FALSE_ _EQ_ _InclTran_) _THEN_ 0.0 _ELSE_ - _wNDilGrenHyp_ _ENDIF_;
_wDTranBlueHyp_ = _IF_ (_FALSE_ _EQ_ _InclTran_) _THEN_ 0.0 _ELSE_ - _wDDilBlueHyp_ _ENDIF_;
_wPTranBlueHyp_ = _IF_ (_FALSE_ _EQ_ _InclTran_) _THEN_ 0.0 _ELSE_ - _wPDilBlueHyp_ _ENDIF_;
_wNTranBlueHyp_ = _IF_ (_FALSE_ _EQ_ _InclTran_) _THEN_ 0.0 _ELSE_ - _wNDilBlueHyp_ _ENDIF_;
...
_uSiLoad_ = _IF_ (_FALSE_ _EQ_ _InclTran_) _THEN_ 0.0 _ELSE_ _uSiLoadSiO2_ + _uSiLoadDet_ + _uSiLoadDiat_ _ENDIF_;
_wSiDilSiO2Hyp_ = _ukDilHyp_ * _oSiO2WHyp_;
_wSiDilDetHyp_ = _ukDilHyp_ * _oSiDetWHyp_;
_wSiDilDiatHyp_ = _cSiDDiat_ * _wDDilDiatHyp_;
_wSiOutflTotHyp_ = _ukOutHyp_ * (_oSiO2WHyp_ + _oSiDetWHyp_ + _cSiDDiat_ * _oDDiatWHyp_);
_wSiTranSiO2Hyp_ = _IF_ (_FALSE_ _EQ_ _InclTran_) _THEN_ 0.0 _ELSE_ - _wSiDilSiO2Hyp_ _ENDIF_;
_wSiTranDetWHyp_ = _IF_ (_FALSE_ _EQ_ _InclTran_) _THEN_ 0.0 _ELSE_ - _wSiDilDetHyp_ _ENDIF_;
_tSiTranTotTHyp_ = _IF_ (_FALSE_ _EQ_ _InclTran_) _THEN_ 0.0 _ELSE_ - (_wSiDilDetHyp_ + _wSiDilSiO2Hyp_ + _wSiDilDiatHyp_) * _uDepthWHyp_ _ENDIF_;
_wDTranZooHyp_ = _IF_ (_FALSE_ _EQ_ _InclTran_) _THEN_ 0.0 _ELSE_( - _wDDilZooHyp_) _ENDIF_;
_wPTranZooHyp_ = _IF_ (_FALSE_ _EQ_ _InclTran_) _THEN_ 0.0 _ELSE_( - _wPDilZooHyp_) _ENDIF_;
_wNTranZooHyp_ = _IF_ (_FALSE_ _EQ_ _InclTran_) _THEN_ 0.0 _ELSE_( - _wNDilZooHyp_) _ENDIF_;
_wDTranIMWHyp_ = _IF_ (_FALSE_ _EQ_ _InclTran_) _THEN_ 0.0 _ELSE_ - _wDDilIMHyp_ _ENDIF_;
_wDTranDetWHyp_ = _IF_ (_FALSE_ _EQ_ _InclTran_) _THEN_ 0.0 _ELSE_ - _wDDilDetHyp_ _ENDIF_;
_wO2TranWHyp_ = _IF_ (_FALSE_ _EQ_ _InclTran_) _THEN_ 0.0 _ELSE_ - _wO2OutflHyp_ _ENDIF_;
_wPTranPO4WHyp_ = _IF_ (_FALSE_ _EQ_ _InclTran_) _THEN_ 0.0 _ELSE_ - _wPDilPO4Hyp_ _ENDIF_;
_wPTranAIMWHyp_ = _IF_ (_FALSE_ _EQ_ _InclTran_) _THEN_ 0.0 _ELSE_ - _wPDilAIMHyp_ _ENDIF_;
_wPTranDetWHyp_ = _IF_ (_FALSE_ _EQ_ _InclTran_) _THEN_ 0.0 _ELSE_ - _wPDilDetHyp_ _ENDIF_;
_wNTranNH4WHyp_ = _IF_ (_FALSE_ _EQ_ _InclTran_) _THEN_ 0.0 _ELSE_ - _wNDilNH4Hyp_ _ENDIF_;
_wNTranNO3WHyp_ = _IF_ (_FALSE_ _EQ_ _InclTran_) _THEN_ 0.0 _ELSE_ - _wNDilNO3Hyp_ _ENDIF_;
_wNTranDetWHyp_ = _IF_ (_FALSE_ _EQ_ _InclTran_) _THEN_ 0.0 _ELSE_ - _wNDilDetHyp_ _ENDIF_;
...
_tDTranTotTHyp_ = _IF_ (_FALSE_ _EQ_ _InclTran_) _THEN_ 0.0 _ELSE_ - _wDDilTotHyp_ * _uDepthWHyp_ _ENDIF_;
_tPTranTotTHyp_ = _IF_ (_FALSE_ _EQ_ _InclTran_) _THEN_ 0.0 _ELSE_ _uPLoad_ - _wPDilTotHyp_ * _uDepthWHyp_ _ENDIF_;
_tNTranTotTHyp_ = _IF_ (_FALSE_ _EQ_ _InclTran_) _THEN_ 0.0 _ELSE_ _uNLoad_ - _wNDilTotHyp_ * _uDepthWHyp_ _ENDIF_;
...
_tPInfPO4WHyp_ = _IF_ (_cQInf_ _GE_ 0.0) _THEN_ _cQInf_ / _mmPerm_ * _oPO4WHyp_ _ELSE_ _cQInf_ / _mmPerm_ * _oPO4S_ _ENDIF_;
_tNInfNH4WHyp_ = _IF_ (_cQInf_ _GE_ 0.0) _THEN_ _cQInf_ / _mmPerm_ * _oNH4WHyp_ _ELSE_ _cQInf_ / _mmPerm_ * _oNH4S_ _ENDIF_;
_tNInfNO3WHyp_ = _IF_ (_cQInf_ _GE_ 0.0) _THEN_ _cQInf_ / _mmPerm_ * _oNO3WHyp_ _ELSE_ _cQInf_ / _mmPerm_ * _oNO3S_ _ENDIF_;
...
_aFunBlueSurfAer_ = _MAX_(0.0, 1.0 - (_kBlueSurfAer_ * _sDBlueSurf_));
...
_uCorVSetIMHyp_ = _IF_ _POW_((_fLutumRef_/_fLutum_) , (0.5))  _LT_ _NearZero_ _THEN_ 1 _ELSE_ _aFunTauSetIMHyp_ * _POW_((_fLutumRef_/_fLutum_) , (0.5)) * _uFunTmSetHyp_ * _cVSetIM_ _ENDIF_;
_tDSetIMHyp_ = _uCorVSetIMHyp_ * _oDIMWHyp_;
_tPSetAIMHyp_ = _oPAIMWHyp_ / _oDIMWHyp_ * _tDSetIMHyp_;
_uCorVSetDetHyp_ = _cVSetDet_ * _aFunTauSetOMHyp_ * _uFunTmSetHyp_;
...
_tPInfPO4WM_ = _IF_ (_InclMarsh_ _EQ_ _TRUE_ _AND_ _fMarsh_ _GT_ _NearZero_) _THEN_ 0.0 _ELSEIF_ (_cQInf_ _GE_ 0.0) _THEN_ _cQInf_ / _mmPerm_ * _oPO4WM_ _ELSE_ _cQInf_ / _mmPerm_ * _oPO4SM_ _ENDIF_;
_tNInfNH4WM_ = _IF_ (_InclMarsh_ _EQ_ _TRUE_ _AND_ _fMarsh_ _GT_ _NearZero_) _THEN_ 0.0 _ELSEIF_ (_cQInf_ _GE_ 0.0) _THEN_ _cQInf_ / _mmPerm_ * _oNH4WM_ _ELSE_ _cQInf_ / _mmPerm_ * _oNH4SM_ _ENDIF_;
_tNInfNO3WM_ = _IF_ (_FALSE_ _EQ_ _InclMarsh_ _OR_ _fMarsh_ _LE_ _NearZero_) _THEN_ 0.0 _ELSEIF_ (_cQInf_ _GE_ 0.0) _THEN_ _cQInf_ / _mmPerm_ * _oNO3WM_ _ELSE_ _cQInf_ / _mmPerm_ * _oNO3SM_ _ENDIF_;
...
_tDSetIMM_ = _IF_ (_InclMarsh_ _EQ_ _TRUE_ _AND_ _fMarsh_ _GT_ _NearZero_) _THEN_ _cVSetIM_ * _uFunTmSetEpi_ * _oDIMWM_ _ELSE_ 0.0 _ENDIF_;
_tPSetAIMM_ = _IF_ (_InclMarsh_ _EQ_ _TRUE_ _AND_ _fMarsh_ _GT_ _NearZero_) _THEN_ _cVSetIM_ * _uFunTmSetEpi_ * _oPAIMWM_ _ELSE_ 0.0 _ENDIF_;
_tDSetDetM_ = _IF_ (_InclMarsh_ _EQ_ _TRUE_ _AND_ _fMarsh_ _GT_ _NearZero_) _THEN_ _cVSetDet_ * _uFunTmSetEpi_ * _oDDetWM_ _ELSE_ 0.0 _ENDIF_;
_tPSetDetM_ = _IF_ (_InclMarsh_ _EQ_ _TRUE_ _AND_ _fMarsh_ _GT_ _NearZero_) _THEN_ _cVSetDet_ * _uFunTmSetEpi_* _oPDetWM_ _ELSE_ 0.0 _ENDIF_;
_tNSetDetM_ = _IF_ (_InclMarsh_ _EQ_ _TRUE_ _AND_ _fMarsh_ _GT_ _NearZero_) _THEN_ _cVSetDet_ * _uFunTmSetEpi_* _oNDetWM_ _ELSE_ 0.0 _ENDIF_;
_tSiSetDetM_ = _IF_ (_InclMarsh_ _EQ_ _TRUE_ _AND_ _fMarsh_ _GT_ _NearZero_) _THEN_ _cVSetDet_ * _uFunTmSetEpi_ * _oSiDetWM_ _ELSE_ 0.0 _ENDIF_;
_tDSetDiatM_ = _IF_ (_InclMarsh_ _EQ_ _TRUE_ _AND_ _fMarsh_ _GT_ _NearZero_) _THEN_ _cVSetDiat_ * _uFunTmSetEpi_ * _oDDiatWM_ _ELSE_ 0.0 _ENDIF_;
_tPSetDiatM_ = _IF_ (_InclMarsh_ _EQ_ _TRUE_ _AND_ _fMarsh_ _GT_ _NearZero_) _THEN_ _cVSetDiat_ * _uFunTmSetEpi_* _oPDiatWM_ _ELSE_ 0.0 _ENDIF_;
_tNSetDiatM_ = _IF_ (_InclMarsh_ _EQ_ _TRUE_ _AND_ _fMarsh_ _GT_ _NearZero_) _THEN_ _cVSetDiat_ * _uFunTmSetEpi_* _oNDiatWM_ _ELSE_ 0.0 _ENDIF_;
_tSiSetDiatM_ = _IF_ (_InclMarsh_ _EQ_ _TRUE_ _AND_ _fMarsh_ _GT_ _NearZero_) _THEN_ _cVSetDiat_ * _uFunTmSetEpi_ * _oSiDiatWM_ _ELSE_ 0.0 _ENDIF_;
_tDSetGrenM_ = _IF_ (_InclMarsh_ _EQ_ _TRUE_ _AND_ _fMarsh_ _GT_ _NearZero_) _THEN_ _cVSetGren_ * _uFunTmSetEpi_ * _oDGrenWM_ _ELSE_ 0.0 _ENDIF_;
_tPSetGrenM_ = _IF_ (_InclMarsh_ _EQ_ _TRUE_ _AND_ _fMarsh_ _GT_ _NearZero_) _THEN_ _cVSetGren_ * _uFunTmSetEpi_* _oPGrenWM_ _ELSE_ 0.0 _ENDIF_;
_tNSetGrenM_ = _IF_ (_InclMarsh_ _EQ_ _TRUE_ _AND_ _fMarsh_ _GT_ _NearZero_) _THEN_ _cVSetGren_ * _uFunTmSetEpi_* _oNGrenWM_ _ELSE_ 0.0 _ENDIF_;
_tDSetBlueM_ = _IF_ (_InclMarsh_ _EQ_ _TRUE_ _AND_ _fMarsh_ _GT_ _NearZero_) _THEN_ _cVSetBlue_ * _uFunTmSetEpi_ * _oDBlueWM_ _ELSE_ 0.0 _ENDIF_;
_tPSetBlueM_ = _IF_ (_InclMarsh_ _EQ_ _TRUE_ _AND_ _fMarsh_ _GT_ _NearZero_) _THEN_ _cVSetBlue_ * _uFunTmSetEpi_* _oPBlueWM_ _ELSE_ 0.0 _ENDIF_;
_tNSetBlueM_ = _IF_ (_InclMarsh_ _EQ_ _TRUE_ _AND_ _fMarsh_ _GT_ _NearZero_) _THEN_ _cVSetBlue_ * _uFunTmSetEpi_* _oNBlueWM_ _ELSE_ 0.0 _ENDIF_;
...
_aChlaBlueHyp_ = _mgPerg_ * _rChDBlueHyp_ * _sDBlueWHyp_;
...
_uCorVSetBlueHyp_ = _cVSetBlue_ * _aFunTauSetOMHyp_ * _uFunTmSetHyp_;
...
_uCorVSetBlueEpi_ = _cVSetBlue_ * _aFunTauSetOMEpi_ * _uFunTmSetEpi_;
...
_uCorVSetGrenHyp_ = _cVSetGren_ * _aFunTauSetOMHyp_ * _uFunTmSetHyp_;
...
_uCorVSetGrenEpi_ = _cVSetGren_ * _aFunTauSetOMEpi_ * _uFunTmSetEpi_;
...
_uCorVSetDiatHyp_ = _cVSetDiat_ * _aFunTauSetOMHyp_ * _uFunTmSetHyp_;
...
_uCorVSetDiatEpi_ = _cVSetDiat_ * _aFunTauSetOMEpi_ * _uFunTmSetEpi_;
...
_tNMarsTotT_ = _IF_ (_InclMarsh_ _EQ_ _TRUE_ _AND_ _fMarsh_ _GT_ _NearZero_) _THEN_ (- _tNInfNH4SM_ - _tNInfNO3SM_ - _tNDifGroundNO3M_ - _tNDifGroundNH4M_ - _tNBurTotM_ - _wNDenitWM_ * _uDepthWM_ - _tNDenitSM_ - _tNManShootPhra_) * _fMarsh_ _ELSE_ 0.0 _ENDIF_;
...
_uTauSubstEpi_ = 1.0 / (_ukDilEpi_+_NearZero_);
...
_wDDilIMEpi_ = _ukDilEpi_ * _oDIMWEpi_;
_wDDilDetEpi_ = _ukDilEpi_ * _oDDetWEpi_;
_wDDilDiatEpi_ = _ukDilEpi_ * _oDDiatWEpi_;
_wDDilGrenEpi_ = _ukDilEpi_ * _oDGrenWEpi_;
_wDDilBlueEpi_ = _ukDilEpi_ * _oDBlueWEpi_;
_wDDilPhytEpi_ = _wDDilDiatEpi_ + _wDDilGrenEpi_ + _wDDilBlueEpi_;
_wDDilZooEpi_ = _ukDilEpi_ * _oDZooEpi_;
_wPDilZooEpi_ = _ukDilEpi_ * _oPZooEpi_;
_wNDilZooEpi_ = _ukDilEpi_ * _oNZooEpi_;
_wPDilPO4Epi_ = _ukDilEpi_ * _oPO4WEpi_;
_wPDilDetEpi_ = _ukDilEpi_*_oPDetWEpi_;
_wPDilAIMEpi_ = _ukDilEpi_ * _oPAIMWEpi_;
_wNDilNH4Epi_ = _ukDilEpi_ * _oNH4WEpi_;
_wNDilNO3Epi_ = _ukDilEpi_ * _oNO3WEpi_;
_wNDilDetEpi_ = _ukDilEpi_ * _oNDetWEpi_;
_wO2InflowEpi_ = _ukDilWatEpi_ * _cO2In_;
_wO2OutflEpi_ = _ukDilEpi_ * _oO2WEpi_;
_wPDilDiatEpi_ = _ukDilEpi_ * _oPDiatWEpi_;
_wNDilDiatEpi_ = _ukDilEpi_ * _oNDiatWEpi_;
_wPDilGrenEpi_ = _ukDilEpi_ * _oPGrenWEpi_;
_wNDilGrenEpi_ = _ukDilEpi_ * _oNGrenWEpi_;
_wPDilBlueEpi_ = _ukDilEpi_ * _oPBlueWEpi_;
_wNDilBlueEpi_ = _ukDilEpi_ * _oNBlueWEpi_;
...
_wDTranDiatEpi_ = _IF_ (_FALSE_ _EQ_ _InclTran_) _THEN_ 0.0 _ELSE_ _uDLoadDiat_ / _uDepthWEpi_ - _wDDilDiatEpi_ _ENDIF_;
_wPTranDiatEpi_ = _IF_ (_FALSE_ _EQ_ _InclTran_) _THEN_ 0.0 _ELSE_ _uPLoadDiat_ / _uDepthWEpi_ - _wPDilDiatEpi_ _ENDIF_;
_wNTranDiatEpi_ = _IF_ (_FALSE_ _EQ_ _InclTran_) _THEN_ 0.0 _ELSE_ _uNLoadDiat_ / _uDepthWEpi_ - _wNDilDiatEpi_ _ENDIF_;
_wDTranGrenEpi_ = _IF_ (_FALSE_ _EQ_ _InclTran_) _THEN_ 0.0 _ELSE_ _uDLoadGren_ / _uDepthWEpi_ - _wDDilGrenEpi_ _ENDIF_;
_wPTranGrenEpi_ = _IF_ (_FALSE_ _EQ_ _InclTran_) _THEN_ 0.0 _ELSE_ _uPLoadGren_ / _uDepthWEpi_ - _wPDilGrenEpi_ _ENDIF_;
_wNTranGrenEpi_ = _IF_ (_FALSE_ _EQ_ _InclTran_) _THEN_ 0.0 _ELSE_ _uNLoadGren_ / _uDepthWEpi_ - _wNDilGrenEpi_ _ENDIF_;
_wDTranBlueEpi_ = _IF_ (_FALSE_ _EQ_ _InclTran_) _THEN_ 0.0 _ELSE_ _uDLoadBlue_ / _uDepthWEpi_ - _wDDilBlueEpi_ _ENDIF_;
_wPTranBlueEpi_ = _IF_ (_FALSE_ _EQ_ _InclTran_) _THEN_ 0.0 _ELSE_ _uPLoadBlue_ / _uDepthWEpi_ - _wPDilBlueEpi_ _ENDIF_;
_wNTranBlueEpi_ = _IF_ (_FALSE_ _EQ_ _InclTran_) _THEN_ 0.0 _ELSE_ _uNLoadBlue_ / _uDepthWEpi_ - _wNDilBlueEpi_ _ENDIF_;
...
_wSiDilSiO2Epi_ = _ukDilEpi_ * _oSiO2WEpi_;
_wSiDilDetEpi_ = _ukDilEpi_ * _oSiDetWEpi_;
_wSiDilDiatEpi_ = _cSiDDiat_ * _wDDilDiatEpi_;
_wSiOutflTotEpi_ = _ukOutEpi_ * (_oSiO2WEpi_ + _oSiDetWEpi_ + _cSiDDiat_ * _oDDiatWEpi_);
_wSiTranSiO2Epi_ = _IF_ (_FALSE_ _EQ_ _InclTran_) _THEN_ 0.0 _ELSE_ _uSiLoadSiO2_ / _uDepthWEpi_ - _wSiDilSiO2Epi_ _ENDIF_;
_wSiTranDetWEpi_ = _IF_ (_FALSE_ _EQ_ _InclTran_) _THEN_ 0.0 _ELSE_ _uSiLoadDet_ / _uDepthWEpi_ - _wSiDilDetEpi_ _ENDIF_;
_tSiTranTotTEpi_ = _IF_ (_FALSE_ _EQ_ _InclTran_) _THEN_ 0.0 _ELSE_ _uSiLoadSiO2_ + _uSiLoadDet_ + _uSiLoadDiat_ - (_wSiDilDetEpi_ + _wSiDilSiO2Epi_ + _wSiDilDiatEpi_) * _uDepthWEpi_ _ENDIF_;
_wDTranZooEpi_ = _IF_ (_FALSE_ _EQ_ _InclTran_) _THEN_ 0.0 _ELSE_( _ukDilWatEpi_ * _cDZooIn_ - _wDDilZooEpi_) _ENDIF_;
_wPTranZooEpi_ = _IF_ (_FALSE_ _EQ_ _InclTran_) _THEN_ 0.0 _ELSE_(_ukDilWatEpi_ * _cPDZooRef_*_cDZooIn_ - _wPDilZooEpi_) _ENDIF_;
_wNTranZooEpi_ = _IF_ (_FALSE_ _EQ_ _InclTran_) _THEN_ 0.0 _ELSE_(_ukDilWatEpi_ * _cNDZooRef_*_cDZooIn_ - _wNDilZooEpi_) _ENDIF_;
_wDTranIMWEpi_ = _IF_ (_FALSE_ _EQ_ _InclTran_) _THEN_ 0.0 _ELSE_ _uDLoadIM_ / _uDepthWEpi_ - _wDDilIMEpi_ _ENDIF_;
_wDTranDetWEpi_ = _IF_ (_FALSE_ _EQ_ _InclTran_) _THEN_ 0.0 _ELSE_ _uDLoadDet_ / _uDepthWEpi_ - _wDDilDetEpi_ _ENDIF_;
_wO2TranWEpi_ = _IF_ (_FALSE_ _EQ_ _InclTran_) _THEN_ 0.0 _ELSE_ _wO2InflowEpi_ - _wO2OutflEpi_ _ENDIF_;
_wPTranPO4WEpi_ = _IF_ (_FALSE_ _EQ_ _InclTran_) _THEN_ 0.0 _ELSE_ _uPLoadPO4_ / _uDepthWEpi_ - _wPDilPO4Epi_ _ENDIF_;
_wPTranAIMWEpi_ = _IF_ (_FALSE_ _EQ_ _InclTran_) _THEN_ 0.0 _ELSE_ _uPLoadAIM_ / _uDepthWEpi_ - _wPDilAIMEpi_ _ENDIF_;
_wPTranDetWEpi_ = _IF_ (_FALSE_ _EQ_ _InclTran_) _THEN_ 0.0 _ELSE_ _uPLoadDet_ / _uDepthWEpi_ - _wPDilDetEpi_ _ENDIF_;
_wNTranNH4WEpi_ = _IF_ (_FALSE_ _EQ_ _InclTran_) _THEN_ 0.0 _ELSE_ _uNLoadNH4_ / _uDepthWEpi_ - _wNDilNH4Epi_ _ENDIF_;
_wNTranNO3WEpi_ = _IF_ (_FALSE_ _EQ_ _InclTran_) _THEN_ 0.0 _ELSE_ _uNLoadNO3_ / _uDepthWEpi_ - _wNDilNO3Epi_ _ENDIF_;
_wNTranDetWEpi_ = _IF_ (_FALSE_ _EQ_ _InclTran_) _THEN_ 0.0 _ELSE_ _uNLoadDet_ / _uDepthWEpi_ - _wNDilDetEpi_ _ENDIF_;
...
_tDTranTotTEpi_ = _IF_ (_FALSE_ _EQ_ _InclTran_) _THEN_ 0.0 _ELSE_ _uDLoad_ - _wDDilTotEpi_ * _uDepthWEpi_ _ENDIF_;
_tPTranTotTEpi_ = _IF_ (_FALSE_ _EQ_ _InclTran_) _THEN_ 0.0 _ELSE_ _uPLoad_ - _wPDilTotEpi_ * _uDepthWEpi_ _ENDIF_;
_tNTranTotTEpi_ = _IF_ (_FALSE_ _EQ_ _InclTran_) _THEN_ 0.0 _ELSE_ _uNLoad_ - _wNDilTotEpi_ * _uDepthWEpi_ _ENDIF_;
...
_tPInfPO4WEpi_ = _IF_ (_aInclStrat_ _EQ_ _TRUE_ ) _THEN_ 0.0 _ELSEIF_ (_cQInf_ _GE_ 0.0) _THEN_ _cQInf_ / _mmPerm_ * _oPO4WEpi_ _ELSE_ _cQInf_ / _mmPerm_ * _oPO4S_ _ENDIF_;
_tNInfNH4WEpi_ = _IF_ (_aInclStrat_ _EQ_ _TRUE_ ) _THEN_ 0.0 _ELSEIF_ (_cQInf_ _GE_ 0.0) _THEN_ _cQInf_ / _mmPerm_ * _oNH4WEpi_ _ELSE_ _cQInf_ / _mmPerm_ * _oNH4S_ _ENDIF_;
_tNInfNO3WEpi_ = _IF_ (_aInclStrat_ _EQ_ _TRUE_ ) _THEN_ 0.0 _ELSEIF_ (_cQInf_ _GE_ 0.0) _THEN_ _cQInf_ / _mmPerm_ * _oNO3WEpi_ _ELSE_ _cQInf_ / _mmPerm_ * _oNO3S_ _ENDIF_;
...
_uCorVSetIMEpi_ = _aFunTauSetIMEpi_ * _POW_((_fLutumRef_/_fLutum_) , (0.5)) * _uFunTmSetEpi_ * _cVSetIM_;
_tDSetIMEpi_ = _uCorVSetIMEpi_ * _oDIMWEpi_;
_tPSetAIMEpi_ = _oPAIMWEpi_ / _oDIMWEpi_ * _tDSetIMEpi_;
_uCorVSetDetEpi_ = _cVSetDet_ * _aFunTauSetOMEpi_ * _uFunTmSetEpi_;
...
_wO2AbioWHyp_ =_IF_ (_aInclStrat_ _EQ_ _FALSE_) _THEN_ 0.0 _ELSE_ _tO2BubHyp_ / _uDepthWHyp_ - _wO2MinDetWHyp_ - _wO2NitrWHyp_ - (_tO2MinDetS_ + _tO2NitrS_) / _uDepthWHyp_ _ENDIF_;
...
_wPAbioPO4WHyp_ =_IF_ (_aInclStrat_ _EQ_ _FALSE_) _THEN_ 0.0 _ELSE_ _wPMinDetWHyp_ - _wPSorpIMWHyp_ - _tPInfPO4WHyp_ / _uDepthWHyp_ + _tPDifPO4Hyp_ / _uDepthWHyp_ + _tPResusPO4_ / _uDepthWHyp_ _ENDIF_;
...
_wNAbioNH4WHyp_ =_IF_ (_aInclStrat_ _EQ_ _FALSE_) _THEN_ 0.0 _ELSE_ _wNMinDetWHyp_ - _wNNitrWHyp_ - _tNInfNH4WHyp_ / _uDepthWHyp_ + (_tNDifNH4Hyp_ + _tNResusNH4_) / _uDepthWHyp_ _ENDIF_;
_wNAbioNO3WHyp_ =_IF_ (_aInclStrat_ _EQ_ _FALSE_) _THEN_ 0.0 _ELSE_ _wNNitrWHyp_ - _wNDenitWHyp_ + (_tNDifNO3Hyp_ + _tNResusNO3_ - _tNInfNO3WHyp_) / _uDepthWHyp_ _ENDIF_;
...
_wSiAbioSiO2WHyp_ =_IF_ (_aInclStrat_ _EQ_ _FALSE_) _THEN_ 0.0 _ELSE_ _wSiMinDetWHyp_ + (1.0 - _fRefrDetS_) * _tSiMinDetS_ / _uDepthWHyp_ _ENDIF_;
...
_wO2AbioWEpi_ = _IF_ (_aInclStrat_ _EQ_ _FALSE_) _THEN_ _tO2AerEpi_ / _uDepthWEpi_ - _wO2MinDetWEpi_ - _wO2NitrWEpi_ - (_tO2MinDetS_ + _tO2NitrS_) / _uDepthWEpi_ _ELSE_ _tO2AerEpi_ / _uDepthWEpi_ - _wO2MinDetWEpi_ - _wO2NitrWEpi_ _ENDIF_;
_wO2AbioM_ = _tO2AerM_ / _uDepthWM_ - _wO2MinDetWM_ - _wO2NitrWM_ - (_tO2MinDetSM_ + _tO2NitrSM_) / _uDepthWM_;
...
_wPAbioPO4WEpi_ =_IF_ (_aInclStrat_ _EQ_ _TRUE_ ) _THEN_ _wPMinDetWEpi_ - _wPSorpIMWEpi_ - _tPInfPO4WEpi_ / _uDepthWEpi_ + _tPDifPO4Epi_ / _uDepthWEpi_ _ELSE_ _wPMinDetWEpi_ - _wPSorpIMWEpi_ - _tPInfPO4WEpi_ / _uDepthWEpi_ + _tPDifPO4Epi_ / _uDepthWEpi_ + _tPResusPO4_ / _uDepthWEpi_ _ENDIF_;
...
_tPAbioPO4S_ = _IF_ ( _aInclStrat_ _EQ_ _TRUE_ ) _THEN_ _tPInfPO4WHyp_ - _tPInfPO4S_ + (1.0-_fRefrDetS_) * _tPMinDetS_ + _tPMinHumS_ - _tPSorpIMS_ - _tPResusPO4_ - _tPDifPO4Hyp_ - _tPDifGroundPO4_ - _tPChemPO4_ _ELSE_ _tPInfPO4WEpi_ - _tPInfPO4S_ + (1.0-_fRefrDetS_) * _tPMinDetS_ + _tPMinHumS_ - _tPSorpIMS_ - _tPResusPO4_ - _tPDifPO4Epi_ - _tPDifGroundPO4_ - _tPChemPO4_ _ENDIF_;
...
_wNAbioNH4WEpi_ = _IF_ (_aInclStrat_ _EQ_ _TRUE_ ) _THEN_ _wNMinDetWEpi_ - _wNNitrWEpi_ - _tNInfNH4WEpi_ / _uDepthWEpi_ + (_tNDifNH4Epi_ ) / _uDepthWEpi_ _ELSE_ _wNMinDetWEpi_ - _wNNitrWEpi_ - _tNInfNH4WEpi_ / _uDepthWEpi_ + (_tNDifNH4Epi_ + _tNResusNH4_) / _uDepthWEpi_ _ENDIF_;
_wNAbioNO3WEpi_ = _IF_ (_aInclStrat_ _EQ_ _TRUE_ ) _THEN_ _wNNitrWEpi_ - _wNDenitWEpi_ + (_tNDifNO3Epi_ - _tNInfNO3WEpi_) / _uDepthWEpi_ _ELSE_ _wNNitrWEpi_ - _wNDenitWEpi_ + (_tNDifNO3Epi_ + _tNResusNO3_ - _tNInfNO3WEpi_) / _uDepthWEpi_ _ENDIF_;
...
_tNAbioNH4S_ = _IF_ ( _aInclStrat_ _EQ_ _TRUE_ ) _THEN_ _tNInfNH4WHyp_ - _tNInfNH4S_ + (1.0-_fRefrDetS_) * _tNMinDetS_ + _tNMinHumS_ - _tNResusNH4_ - _tNDifNH4Hyp_ - _tNDifGroundNH4_ - _tNNitrS_ _ELSE_ _tNInfNH4WEpi_ - _tNInfNH4S_ + (1.0-_fRefrDetS_) * _tNMinDetS_ + _tNMinHumS_ - _tNResusNH4_ - _tNDifNH4Epi_ - _tNDifGroundNH4_ - _tNNitrS_ _ENDIF_;
_tNAbioNO3S_ = _IF_ ( _aInclStrat_ _EQ_ _TRUE_ ) _THEN_ _tNInfNO3WHyp_ - _tNInfNO3S_ + _tNNitrS_ - _tNDenitS_ - _tNResusNO3_ - _tNDifNO3Hyp_ - _tNDifGroundNO3_ _ELSE_ _tNInfNO3WEpi_ - _tNInfNO3S_ + _tNNitrS_ - _tNDenitS_ - _tNResusNO3_ - _tNDifNO3Epi_ - _tNDifGroundNO3_ _ENDIF_;
...
_tNAbioTotT_ = _uNErosOM_ - _tNDenitS_ - _wNDenitWEpi_ * _uDepthWEpi_ - _wNDenitWHyp_ * _uDepthWHyp_ - _tNInfNH4S_ - _tNInfNO3S_ - _tNDifGroundNO3_ - _tNDifGroundNH4_;
_wSiAbioSiO2WEpi_ = _IF_ (_aInclStrat_ _EQ_ _FALSE_ ) _THEN_ _wSiMinDetWEpi_ + (1.0 - _fRefrDetS_) * _tSiMinDetS_ / _uDepthWEpi_ _ELSE_ _wSiMinDetWEpi_ _ENDIF_;
...
_aChlaBlueEpi_ = _mgPerg_ * _rChDBlueEpi_ * _sDBlueWEpi_;
...
_aLLimBlueSurf_ = _IF_ (_InclSurf_ _EQ_ _FALSE_ _OR_ _sDBlueSurf_ _LT_ _cDBlueSurfMin_) _THEN_ -9999 _ELSE_ _MAX_(0.0,_UseSteeleBlue_ *(_EXP_(1.0) /(_aExtSurf_) *(_EXP_(- _aLPARBotSurf_/(_cLOptRefBlue_ *  _uFunTmProdBlueSurf_)) - _EXP_(- _uLPARSurf_ /(_cLOptRefBlue_ *  _uFunTmProdBlueSurf_)))) +(1.0 - _UseSteeleBlue_) *(1.0 /(_aExtSurf_) * _LN_((1.0 + _uLPARSurf_ / (_hLRefBlue_ * _uFunTmProdBlueSurf_)) / (1.0 + _aLPARBotSurf_ /(_hLRefBlue_ * _uFunTmProdBlueSurf_))))) _ENDIF_;
_aRepLLimBlue_ = (_aLLimBlueSurf_* _sDBlueSurf_ + _aLLimBlueEpi_* _sDBlueWEpi_) / (_sDBlueSurf_ + _sDBlueWEpi_);
_rChDBlueSurf_ = _cChDBlueMax_ -(_cChDBlueMax_ - _cChDBlueMin_) * _aLLimBlueSurf_;
_aChlaBlueSurf_ = _IF_ (_InclSurf_ _EQ_ _FALSE_ _OR_ _sDBlueSurf_ _LT_ _cDBlueSurfMin_) _THEN_ 0.0 _ELSE_ _mgPerg_ * _rChDBlueSurf_ * _sDBlueSurf_ _ENDIF_;
_oChlaBlueW_ = _IF_ ( _aInclStrat_ _EQ_ _TRUE_ ) _THEN_ (_oChlaBlueEpi_ * _uDepthWEpi_ + _oChlaBlueHyp_ * _uDepthWHyp_) / _sDepthW_ _ELSE_ (_oChlaBlueEpi_ * _uDepthWEpi_) / _sDepthW_ _ENDIF_;
_oChlaBlue_ = _IF_ ( _aInclStrat_ _EQ_ _TRUE_ ) _THEN_ (_oChlaBlueEpi_ * _uDepthWEpi_ + _oChlaBlueHyp_ * _uDepthWHyp_ + _aChlaBlueSurf_) / _sDepthW_ _ELSE_ (_oChlaBlueEpi_ * _uDepthWEpi_ + _aChlaBlueSurf_ ) / _sDepthW_ _ENDIF_;
_aChlaLimFloBlueSurf_ = _IF_ (_InclSurf_ _EQ_ _FALSE_ _OR_ _sDBlueSurf_ _LT_ _cDBlueSurfMin_) _THEN_ 0.0 _ELSE_ (1.0 - (_POW_ ((_aChlaBlueSurf_ / _cDepthSurf_) , (-_cStepPow_))) / ((_POW_ (_cChlaThrBlue_ , (-_cStepPow_))) + (_POW_ ((_aChlaBlueSurf_ / _cDepthSurf_) , (-_cStepPow_)))));
_aChlaLimFloBlueEpi_ = _IF_ (_InclSurf_ _EQ_ _FALSE_  _OR_ _sDBlueWEpi_ _LT_ _cDBlueSurfMin_) _THEN_ 0.0 _ELSE_ (1.0 - (_POW_ (_oChlaBlueEpi_ , (-_cStepPow_))) / ((_POW_ (_cChlaThrBlue_ , (-_cStepPow_))) + (_POW_ (_oChlaBlueEpi_ , (-_cStepPow_)))));
_aChlaLimFloBlueHyp_ = _IF_ (_aInclStrat_ _EQ_ _FALSE_ _OR_ _sDBlueWHyp_ _LT_ _cDBlueSurfMin_) _THEN_ 0.0 _ELSEIF_ (_InclSurf_ _EQ_ _FALSE_) _THEN_ 0.0 _ELSE_  (1.0 - (_POW_ (_oChlaBlueHyp_ , (-_cStepPow_))) / ((_POW_ (_cChlaThrBlue_ , (-_cStepPow_))) + (_POW_ (_oChlaBlueHyp_ , (-_cStepPow_)))));
_aVWLimFloBlue_ = _IF_ (_InclSurf_ _EQ_ _FALSE_) _THEN_ 0.0 _ELSE_  (1.0 - (_POW_ (_uVWind_ , _cStepPow_)) / ((_POW_ (_cVWindThrBlue_ , _cStepPow_)) + (_POW_ (_uVWind_ , _cStepPow_))));
_aTmLimFloBlueSurf_ = _IF_ (_InclSurf_ _EQ_ _FALSE_ _OR_ _sDBlueSurf_ _LT_ _cDBlueSurfMin_) _THEN_ 0.0 _ELSE_ (1.0 - (_POW_ (_uTmSurf_ , (-_cStepPow_))) / ((_POW_ (_cTmThrBlue_ , (-_cStepPow_))) + (_POW_ (_uTmSurf_ , (-_cStepPow_)))));
_aTmLimFloBlueEpi_ = _IF_ (_InclSurf_ _EQ_ _FALSE_) _THEN_ 0.0 _ELSE_ (1.0 - (_POW_ (_uTmEpi_ , (-_cStepPow_))) / ((_POW_ (_cTmThrBlue_ , (-_cStepPow_))) + (_POW_ (_uTmEpi_ , (-_cStepPow_)))));
_aTmLimFloBlueHyp_ = _IF_ (_aInclStrat_ _EQ_ _FALSE_) _THEN_ 0.0 _ELSEIF_ (_InclSurf_ _EQ_ _FALSE_) _THEN_ 0.0 _ELSE_  (1.0 - (_POW_ (_uTmHyp_ , (-_cStepPow_))) / ((_POW_ (_cTmThrBlue_ , (-_cStepPow_))) + (_POW_ (_uTmHyp_ , (-_cStepPow_)))));
...
_uVFloBlueSurf_ =  _IF_ (_InclSurf_ _EQ_ _FALSE_ _OR_ _sDBlueSurf_ _LT_ _cDBlueSurfMin_) _THEN_ 0.0 _ELSE_ _aTrigFloBlueSurf_ * _cVFloMaxBlueW_ _ENDIF_;
...
_uCorVSetBlueSurf_ = _cVSetBlue_ * _aFunTauSetOMSurf_ * _uFunTmSetSurf_;
_uVBlueSurf_ = _IF_ (_InclSurf_ _EQ_ _FALSE_ _OR_ _sDBlueSurf_ _LT_ _cDBlueSurfMin_) _THEN_ - _uCorVSetBlueSurf_ _ELSE_ _uVFloBlueSurf_ - _uCorVSetBlueSurf_ _ENDIF_;
_tDSetBlueSurf_ = _IF_ (_InclSurf_ _EQ_ _FALSE_ _OR_ _sDBlueSurf_ _LT_ _cDBlueSurfMin_) _THEN_ 0.0 _ELSEIF_ (_uVBlueSurf_ _LT_ 0.0) _THEN_ _sDBlueSurf_  / _cDepthSurf_ * (- _uVBlueSurf_) _ELSE_ 0.0 _ENDIF_;
_rNDBlueSurf_ = _sNBlueSurf_ / (_sDBlueSurf_ + _NearZero_);
_tNSetBlueSurf_ = _rNDBlueSurf_ * _tDSetBlueSurf_;
_rPDBlueSurf_ = _sPBlueSurf_ / (_sDBlueSurf_ + _NearZero_);
...
_ukDilSurf_ = _ukDilEpi_;
_tDDilBlueSurf_ =  _IF_ (_InclSurf_ _EQ_ _FALSE_ _OR_ _sDBlueSurf_ _LT_ _cDBlueSurfMin_) _THEN_ 0.0 _ELSE_ _ukDilSurf_ * _sDBlueSurf_ _ENDIF_;
_tNDilBlueSurf_ =  _IF_ (_InclSurf_ _EQ_ _FALSE_ _OR_ _sDBlueSurf_ _LT_ _cDBlueSurfMin_) _THEN_ 0.0 _ELSE_ _ukDilSurf_ * _sNBlueSurf_ _ENDIF_;
_tPDilBlueSurf_ =  _IF_ (_InclSurf_ _EQ_ _FALSE_ _OR_ _sDBlueSurf_ _LT_ _cDBlueSurfMin_) _THEN_ 0.0 _ELSE_ _ukDilSurf_ * _sPBlueSurf_ _ENDIF_;
_tDLoadBlueSurf_ = 0.0;
_tPLoadBlueSurf_ = 0.0;
_tNLoadBlueSurf_ = 0.0;
_tDTranBlueSurf_ = _IF_ (_FALSE_ _EQ_ _InclTran_) _THEN_ 0.0 _ELSEIF_ (_InclSurf_ _EQ_ _FALSE_ _OR_ _sDBlueSurf_ _LT_ _cDBlueSurfMin_) _THEN_ 0.0 _ELSE_ _tDLoadBlueSurf_ - _tDDilBlueSurf_ _ENDIF_;
_tPTranBlueSurf_ = _IF_ (_FALSE_ _EQ_ _InclTran_) _THEN_ 0.0 _ELSEIF_ (_InclSurf_ _EQ_ _FALSE_ _OR_ _sDBlueSurf_ _LT_ _cDBlueSurfMin_) _THEN_ 0.0 _ELSE_ _tPLoadBlueSurf_ - _tPDilBlueSurf_ _ENDIF_;
_tNTranBlueSurf_ = _IF_ (_FALSE_ _EQ_ _InclTran_) _THEN_ 0.0 _ELSEIF_ (_InclSurf_ _EQ_ _FALSE_) _THEN_ 0.0 _ELSE_ _tNLoadBlueSurf_ - _tNDilBlueSurf_ _ENDIF_;
...
_aNutLimBlueSurf_ = _IF_ (_InclSurf_ _EQ_ _FALSE_ _OR_ _sDBlueSurf_ _LT_ _cDBlueSurfMin_) _THEN_ -9999 _ELSE_ _MIN_(_aPLimBlueSurf_,_MIN_(_aNLimBlueSurf_,_aSiLimBlueSurf_)) _ENDIF_;
_aRepPLimBlue_ = (_aPLimBlueSurf_* _sDBlueSurf_ + _aPLimBlueEpi_* _sDBlueWEpi_) / (_sDBlueSurf_ + _sDBlueWEpi_);
_aRepNLimBlue_ = (_aNLimBlueSurf_* _sDBlueSurf_ + _aNLimBlueEpi_* _sDBlueWEpi_) / (_sDBlueSurf_ + _sDBlueWEpi_);
_aRepNutLimBlue_ = (_aNutLimBlueSurf_* _sDBlueSurf_ + _aNutLimBlueEpi_* _sDBlueWEpi_) / (_sDBlueSurf_ + _sDBlueWEpi_);
_aMuBlueSurf_ = _aNutLimBlueSurf_ * _aMuTmLBlueSurf_;
_tDAssBlueSurf_ = _IF_ (_InclSurf_ _EQ_ _FALSE_ _OR_ _sDBlueSurf_ _LT_ _cDBlueSurfMin_) _THEN_ 0.0 _ELSE_ _aMuBlueSurf_ * _sDBlueSurf_ _ENDIF_;
...
_tNUptBlueSurf_ = _IF_ (_InclSurf_ _EQ_ _FALSE_ _OR_ _sDBlueSurf_ _LT_ _cDBlueSurfMin_) _THEN_ 0.0 _ELSE_ _aVNUptBlueSurf_ * _sDBlueSurf_ _ENDIF_;
_aNfixBlueSurf_ = _rNfixBlueSurf_ *_aChlaBlueSurf_ /_ugPerg_;
_tNUptBlueAirSurf_ = _IF_ (_InclSurf_ _EQ_ _FALSE_ _OR_ _sDBlueSurf_ _LT_ _cDBlueSurfMin_) _THEN_ 0.0 _ELSEIF_ (_InclNfix_ _EQ_ _FALSE_) _THEN_ 0.0 _ELSE_ _aNfixBlueSurf_ _ENDIF_;
_tNUptBlueWSurf_ = _IF_ (_InclSurf_ _EQ_ _FALSE_ _OR_ _sDBlueSurf_ _LT_ _cDBlueSurfMin_) _THEN_ 0.0 _ELSEIF_ (_InclNfix_ _EQ_ _FALSE_) _THEN_ _tNUptBlueSurf_ _ELSE_ _tNUptBlueSurf_ - _tNUptBlueAirSurf_ _ENDIF_;
...
_tPUptBlueSurf_ = _IF_ (_InclSurf_ _EQ_ _FALSE_ _OR_ _sDBlueSurf_ _LT_ _cDBlueSurfMin_) _THEN_ 0.0 _ELSE_ _aVPUptBlueSurf_ * _sDBlueSurf_ _ENDIF_;
_tDRespBlueSurf_ = _IF_ (_InclSurf_ _EQ_ _FALSE_ _OR_ _sDBlueSurf_ _LT_ _cDBlueSurfMin_) _THEN_ 0.0 _ELSE_ _ukDRespTmBlueSurf_ *_sDBlueSurf_ _ENDIF_;
_tNExcrBlueSurf_ = _IF_ (_InclSurf_ _EQ_ _FALSE_ _OR_ _sDBlueSurf_ _LT_ _cDBlueSurfMin_) _THEN_ 0.0 _ELSE_ (_rNDBlueSurf_ * 2.0 )/(_cNDBlueMax_ + _rNDBlueSurf_) * _rNDBlueSurf_ * _tDRespBlueSurf_ _ENDIF_;
_tPExcrBlueSurf_ = _IF_ (_InclSurf_ _EQ_ _FALSE_ _OR_ _sDBlueSurf_ _LT_ _cDBlueSurfMin_) _THEN_ 0.0 _ELSE_ (_rPDBlueSurf_ * 2.0 )/(_cPDBlueMax_ + _rPDBlueSurf_) * _rPDBlueSurf_ * _tDRespBlueSurf_ _ENDIF_;
_tDMortBlueSurf_ = _IF_ (_InclSurf_ _EQ_ _FALSE_ _OR_ _sDBlueSurf_ _LT_ _cDBlueSurfMin_) _THEN_ 0.0 _ELSE_ _kMortBlueW_ * _sDBlueSurf_ _ENDIF_;
_tNMortBlueSurf_ = _IF_ (_InclSurf_ _EQ_ _FALSE_ _OR_ _sDBlueSurf_ _LT_ _cDBlueSurfMin_) _THEN_ 0.0 _ELSE_ _kMortBlueW_ * _sNBlueSurf_ _ENDIF_;
...
_tPMortBlueSurf_ = _IF_ (_InclSurf_ _EQ_ _FALSE_ _OR_ _sDBlueSurf_ _LT_ _cDBlueSurfMin_) _THEN_ 0.0 _ELSE_ _kMortBlueW_ * _sPBlueSurf_ _ENDIF_;
...
_tDLossBlueSurf_ = _IF_ (_InclSurf_ _EQ_ _FALSE_ _OR_ _sDBlueSurf_ _LT_ _cDBlueSurfMin_) _THEN_ 0.0 _ELSE_ _ukLossTmBlueSurf_ * _sDBlueSurf_ _ENDIF_;
_tPLossBlueSurf_ = _IF_ (_InclSurf_ _EQ_ _FALSE_ _OR_ _sDBlueSurf_ _LT_ _cDBlueSurfMin_) _THEN_ 0.0 _ELSE_ _rPDBlueSurf_ * _tDLossBlueSurf_ _ENDIF_;
_tNLossBlueSurf_ = _IF_ (_InclSurf_ _EQ_ _FALSE_ _OR_ _sDBlueSurf_ _LT_ _cDBlueSurfMin_) _THEN_ 0.0 _ELSE_ _rNDBlueSurf_ * _tDLossBlueSurf_ _ENDIF_;
...
_oChla_ = _IF_ ( _aInclStrat_ _EQ_ _TRUE_ ) _THEN_ (_oChlaEpi_ * _uDepthWEpi_ + _oChlaHyp_ * _uDepthWHyp_ + _aChlaBlueSurf_) / _sDepthW_ _ELSE_ (_oChlaEpi_ * _uDepthWEpi_+ _aChlaBlueSurf_ ) / _sDepthW_ _ENDIF_;
_oChlaW_ = _IF_ ( _aInclStrat_ _EQ_ _TRUE_ ) _THEN_ (_oChlaEpi_ * _uDepthWEpi_ + _oChlaHyp_ * _uDepthWHyp_) / _sDepthW_ _ELSE_ (_oChlaEpi_ * _uDepthWEpi_) / _sDepthW_ _ENDIF_;
...
_aDFoodZooEpi_ =  _IF_ (_InclSurf_ _EQ_ _FALSE_ _OR_ _sDBlueSurf_ _LT_ _cDBlueSurfMin_) _THEN_ _cPrefDiat_ * _sDDiatWEpi_ + _cPrefGren_ * _sDGrenWEpi_ + _cPrefBlue_ * _sDBlueWEpi_ + _cPrefDet_ * _sDDetWEpi_ _ELSE_ _cPrefDiat_ * _sDDiatWEpi_ + _cPrefGren_ * _sDGrenWEpi_ + _cPrefBlue_ * _sDBlueWEpi_ + _cPrefBlueSurf_ * _sDBlueSurf_ + _cPrefDet_ * _sDDetWEpi_ _ENDIF_;
...
_wDConsBlueZooSurf_ =  _IF_ (_InclSurf_ _EQ_ _FALSE_ _OR_ _sDBlueSurf_ _LT_ _cDBlueSurfMin_) _THEN_ 0.0 _ELSE_ _cPrefBlueSurf_ *_sDBlueSurf_ / _aDFoodZooEpi_ * _wDConsZooEpi_ _ENDIF_;
_tDConsBlueZooSurf_ =  _IF_ (_InclSurf_ _EQ_ _FALSE_ _OR_ _sDBlueSurf_ _LT_ _cDBlueSurfMin_) _THEN_ 0.0 _ELSE_ _wDConsBlueZooSurf_ *_uDepthWEpi_ _ENDIF_;
_wDConsPhytZooEpi_ = _IF_ (_InclSurf_ _EQ_ _FALSE_ _OR_ _sDBlueSurf_ _LT_ _cDBlueSurfMin_) _THEN_ _wDConsDiatZooEpi_ + _wDConsGrenZooEpi_ + _wDConsBlueZooEpi_ _ELSE_ _wDConsDiatZooEpi_ + _wDConsGrenZooEpi_ + _wDConsBlueZooEpi_ + _wDConsBlueZooSurf_ _ENDIF_;
...
_aPFoodZooEpi_ = _IF_ (_InclSurf_ _EQ_ _FALSE_ _OR_ _sDBlueSurf_ _LT_ _cDBlueSurfMin_) _THEN_ _cPrefDiat_*_sPDiatWEpi_ + _cPrefGren_*_sPGrenWEpi_ + _cPrefBlue_ * _sPBlueWEpi_  + _cPrefDet_ * _sPDetWEpi_ _ELSE_ _cPrefDiat_*_sPDiatWEpi_ + _cPrefGren_*_sPGrenWEpi_ + _cPrefBlue_*_sPBlueWEpi_ + _cPrefBlueSurf_ *_sPBlueSurf_ + _cPrefDet_ * _sPDetWEpi_ _ENDIF_;
...
_wPConsPhytZooEpi_ = _IF_ (_InclSurf_ _EQ_ _FALSE_ _OR_ _sDBlueSurf_ _LT_ _cDBlueSurfMin_) _THEN_ _wPConsDiatZooEpi_ + _wPConsGrenZooEpi_ + _wPConsBlueZooEpi_ _ELSE_ _wPConsDiatZooEpi_ + _wPConsGrenZooEpi_ + _wPConsBlueZooEpi_ + _wPConsBlueZooSurf_ _ENDIF_;
...
_aNFoodZooEpi_ =  _IF_ (_InclSurf_ _EQ_ _FALSE_ _OR_ _sDBlueSurf_ _LT_ _cDBlueSurfMin_) _THEN_ _cPrefDiat_*_sNDiatWEpi_ + _cPrefGren_*_sNGrenWEpi_ + _cPrefBlue_*_sNBlueWEpi_ + _cPrefDet_ * _sNDetWEpi_ _ELSE_ _cPrefDiat_*_sNDiatWEpi_ + _cPrefGren_*_sNGrenWEpi_ + _cPrefBlue_*_sNBlueWEpi_ + _cPrefBlueSurf_*_sNBlueSurf_ + _cPrefDet_ * _sNDetWEpi_ _ENDIF_;
...
_wNConsPhytZooEpi_ = _IF_ (_InclSurf_ _EQ_ _FALSE_ _OR_ _sDBlueSurf_ _LT_ _cDBlueSurfMin_) _THEN_  _wNConsDiatZooEpi_ + _wNConsGrenZooEpi_ + _wNConsBlueZooEpi_ _ELSE_ _wNConsDiatZooEpi_ + _wNConsGrenZooEpi_ + _wNConsBlueZooEpi_ + _wNConsBlueZooSurf_ _ENDIF_;
...
_tDAgeFish_ = _IF_ (_FALSE_ _EQ_ _InclSeason_) _THEN_ ((1/_DaysInYear_)*_fAgeFish_) * _sDFiJv_ _ELSEIF_ (_Day_ _GE_ 364.0) _THEN_ _fAgeFish_ * _aDFiJv_ *_PerDay_ _ELSE_ 0.0 _ENDIF_;
...
_tDEnvFiAd_ = _MAX_(0.0,_ukDIncrFiAd_ /(_cDCarrFish_ - _sDFiJv_) * _aDFiAd_*_aDFiAd_);
...
_tDWebBlueSurf_ = _IF_ (_InclWeb_ _EQ_ _FALSE_ _OR_ _InclSurf_ _EQ_ _FALSE_ _OR_ _sDBlueSurf_ _LT_ _cDBlueSurfMin_) _THEN_ 0.0 _ELSE_ - _tDConsBlueZooSurf_ _ENDIF_;
...
_tPWebBlueSurf_ = _IF_ (_InclWeb_ _EQ_ _FALSE_ _OR_ _InclSurf_ _EQ_ _FALSE_ _OR_ _sDBlueSurf_ _LT_ _cDBlueSurfMin_) _THEN_ 0.0 _ELSE_ - _tPConsBlueZooSurf_ _ENDIF_;
...
_tNWebBlueSurf_ = _IF_ (_InclWeb_ _EQ_ _FALSE_ _OR_ _InclSurf_ _EQ_ _FALSE_ _OR_ _sDBlueSurf_ _LT_ _cDBlueSurfMin_) _THEN_ 0.0 _ELSE_ - _tNConsBlueZooSurf_ _ENDIF_;
...
_aRelDeltaWHyp_ = _IF_ ( _aInclStrat_ _EQ_ _FALSE_ ) _THEN_ 0.0 _ELSE_ (_vDredDepthW_) / _uDepthWHyp_ _ENDIF_ ;
...
_aDTotT_ = _aDTotTHyp_ + (_oDIMWEpi_+_oDDetWEpi_+_oDDiatWEpi_+_oDGrenWEpi_+_oDBlueWEpi_+_oDZooEpi_) * _uDepthWEpi_ +_aDFish_+_sDPisc_+_aDVeg_ +_sDIMS_+_sDHumS_+_sDDetS_+_sDDiatS_+_sDGrenS_+_sDBlueS_+_sDBent_ + _aDTotM_ + _sDBlueSurf_;
_aNTotT_ = _aNTotTHyp_+ (_oNH4WEpi_+_oNO3WEpi_+_oNDetWEpi_+_oNDiatWEpi_+_oNGrenWEpi_+_oNBlueWEpi_ +_oNZooEpi_)*_uDepthWEpi_ +_aNFish_+_aNPisc_+_aNVeg_ +_sNH4S_+_sNO3S_+_sNDetS_+_sNHumS_+_sNDiatS_+_sNGrenS_+_sNBlueS_ +_sNBent_ + _aNTotM_ + _sNBlueSurf_;
_aPTotT_ = _aPTotTHyp_ + (_oPO4WEpi_+_oPDetWEpi_+_oPDiatWEpi_+_oPGrenWEpi_+_oPBlueWEpi_ +_oPZooEpi_+_oPAIMWEpi_) * _uDepthWEpi_ +_aPFish_+_aPPisc_+_aPVeg_ +_sPO4S_+_sPDetS_+_sPHumS_+_sPDiatS_+_sPGrenS_+_sPBlueS_ +_sPAIMS_+_sPBent_ + _aPTotM_ +_sPBlueSurf_;
...
_aO2Error_ = _aO2TotT_ - _sO2ExtTotT_;
